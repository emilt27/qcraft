...
fn where_contains_escapes_percent_in_db() {
    ...
    client
        .execute(
            "INSERT INTO \"users\" VALUES (10, '50% off', 'promo@test.com', 20, TRUE, 'sales')",
            &[],
        )
        .unwrap();
    client
        .execute(
            "INSERT INTO \"users\" VALUES (11, '500 items', 'items@test.com', 20, TRUE, 'sales')",
            &[],
        )
        .unwrap();
...
fn where_contains_escapes_underscore_in_db() {
    ...
    client
        .execute(
            "INSERT INTO \"users\" VALUES (13, 'useradmin', 'uadmin@test.com', 20, TRUE, 'engineering')",
            &[],
        )
        .unwrap();
